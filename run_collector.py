...
#------------------ 최근 2년간 부동산 데이터 ------------------#
# 수집 날짜
start = (datetime.today() - relativedelta(years=2)).strftime("%Y%m")
end = datetime.today().strftime("%Y%m")
freq = "M" # 월별

# 주택매매가격지수, 주택전세가격지수, 주택월세통합가격지수
list1 = ["901Y093", "901Y094", "901Y095"]
list2 = ["H69B", "H69C", "H69D"]
list3 = ["R70F", "R70G", "R70H", "R70I", "R70J", "R70K", "R70L", "R70M", "R70N", "R70O", "R70P", "R70Q", "R70R", "R70S", "R70T", "R70U", "R70V"]
code_lst = list(product(list1, list2, list3))

real_estate = collect_economic_data.real_estate(start, end, code_lst, freq)
db.insert_economic(real_estate, "real_estate")