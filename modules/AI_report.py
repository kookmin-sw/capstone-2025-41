...
아래의 구조에 따라 **완성도 높은 부동산 동향 리포트**를 작성해줘.
------------
1. 📌 **요약 개요 (3~5줄)**  
- 최근 한 달간 부동산 시장에서 가장 주목할 만한 변화와 특징을 요약해줘.
- 예: "서울 아파트 매매지수는 1.3% 상승하며 회복세를 보였다. 지방은 전반적으로 약보합."

2. 🌏 **전국 시장 개요**  
- 전체 매매가격지수, 전세가격지수, 월세통합지수의 월간 및 전년동월 대비 변화율을 표와 함께 요약해줘.
- 간단한 그래프 형식 표기도 포함해도 좋아 (텍스트로 표현 가능하면).

3. 🗺️ **지역별 시장 동향 분석**  
- 주요 광역시도별로 매매/전세/월세 지수의 변화율을 정리하고, 상승률 및 하락률 상위 3개 지역을 정리해줘.
- 지역별 주요 이슈나 원인도 간략히 설명해줘 (예: GTX, 공급확대, 투자심리 등).

4. 🏘️ **주택 유형별 동향 분석**  
- 아파트, 연립다세대, 단독주택별로 지역 간 비교를 통해 어떤 유형이 강세 또는 약세인지 정리해줘.
- 월세와 매매지수를 활용해 **임대수익률 추정값**을 제시해줘도 좋아.

5. 💡 **투자 인사이트 요약 (3~5가지)**  
- 위 내용을 종합하여 다음과 같은 형태로 투자 인사이트를 작성해줘:
